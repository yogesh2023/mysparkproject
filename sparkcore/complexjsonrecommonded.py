...
data='C:/venu sir/drivers-20220727T054209Z-001/drivers/companies.json'
df=spark.read.format('json').option('header','True').option('inferSchema','True').option('multiline','true').load(data)
...
op='C:/venu sir/drivers-20220727T054209Z-001/drivers/output'
